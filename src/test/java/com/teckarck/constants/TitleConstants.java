...
public class TitleConstants {
	...
	public static final String ACCOUNTS_PAGE_TITLE="Accounts: Home ~ Salesforce - Developer Edition";
	...
	public static final String CREATE_REPORT_PAGE_TITLE="Unsaved Report ~ Salesforce - Developer Edition";
